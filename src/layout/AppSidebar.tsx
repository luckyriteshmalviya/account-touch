...
// Commented out Others completely ✅
...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    ["main" /*, "others"*/].forEach((menuType) => {
      const items = menuType === "main" ? navItems : []; // removed othersItems
  ...
  return (
    <aside
      className={`overflow-x-hidden fixed mt-16 flex flex-col lg:mt-0 top-0 px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out z-50 border-r border-gray-200 
    ...
    >
      ...
      >
        {/* udpate on 3/5/2025 */}
        <Link to="/">
          {/* <b className="text-xl">AccountTouch</b> */}
