...
import { getQuestionListService, deleteQuestionService } from "../../../services/restApi/questions";
                  ...
                  questions.map((q) => (
                    <TableRow key={q.id}>
                      ...
                      <TableCell className="px-4 py-3">
                        {q.question_type.split("_").map(item => item[0].toUpperCase() + item.slice(1)).join(' ')}
                      </TableCell>
                      <TableCell className="px-4 py-3">
