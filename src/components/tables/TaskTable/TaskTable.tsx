        ...
        {/* udpate on 3/5/2025 */}
          <div className="min-w-[850px]">
            <Table>
              <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                <TableRow>
                  {["#", "Title", "Status", "Priority", "Client ID", "Created At", "Actions"].map(
                    (header) => (
                      <TableCell
                        key={header}
                        isHeader
              ...
              <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                {tasks.map((task:any) => (
                  <TableRow key={task.id} className="text-center">
                    <TableCell className="px-4 py-4 text-start">{task?.id}</TableCell>
                    <TableCell className="px-4 py-4 text-start">{task?.title}</TableCell>
                    ...
                    <TableCell className="px-4 py-4 text-start">{task?.client?.id}</TableCell>
