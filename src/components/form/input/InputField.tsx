...
const Input: FC<InputProps> = ({
  ...
  hint,
   ...
   // If disabled, apply styles
   if (disabled) {
     inputClasses += ` disabled:text-black disabled:bg-white disabled:border-gray-500 opacity-70 cursor-not-allowed dark:bg-gray-800 dark:text-gray-400 dark:border-gray-700`;
   } else if (error) {
