...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | boltecpros - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for boltecpros - React.js Tailwind CSS Admin Dashboard Template"
      />
