...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | boltecpros - React.js Admin Dashboard Template"
        description="This is React.js Videos page for boltecpros - React.js Tailwind CSS Admin Dashboard Template"
      />
