...
export default function ViewQuestionPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white dark:bg-gray-900 rounded-lg p-8 shadow">
      <h1 className="text-2xl font-semibold mb-6 text-center">Question Details</h1>
        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          <tbody className="divide-y divide-gray-100 dark:divide-gray-700 text-left">
            ...
            <tr>
              ...
              <td className="px-6 py-4 text-gray-900 dark:text-white">{question.id}</td>
            </tr>

            {/* Text */}
            <tr>
              <td className="px-6 py-4 font-semibold text-gray-700 dark:text-gray-300">Text</td>
              <td className="px-6 py-4 text-gray-900 dark:text-white">{question.text || "-"}</td>
            </tr>

            {/* Description */}
            <tr>
              <td className="px-6 py-4 font-semibold text-gray-700 dark:text-gray-300">Description</td>
              <td className="px-6 py-4 text-gray-800 dark:text-gray-300">{question.description || "-"}</td>
            </tr>

            {/* Question Type */}
            <tr>
              <td className="px-6 py-4 font-semibold text-gray-700 dark:text-gray-300">Question Type</td>
              <td className="px-6 py-4 text-gray-900 dark:text-white">{question.question_type || "-"}</td>
            </tr>

            {/* Is Required */}
            <tr>
              <td className="px-6 py-4 font-semibold text-gray-700 dark:text-gray-300">Is Required</td>
            ...
            <tr>
              ...
              <td className="px-6 py-4 text-gray-900 dark:text-white">{question.order}</td>
            </tr>

            {/* Choices */}
            <tr>
              <td className="px-6 py-4 font-semibold text-gray-700 dark:text-gray-300">Choices</td>
