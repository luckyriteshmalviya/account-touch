...
const DocumentTypeForm = ({
  ...
  const validate = () => {
    ...
    if (!documentType.description?.trim()) newErrors.description = "Description is required.";
    setErrors(newErrors);
  ...
  return (
    <form onSubmit={handleSubmit}>
      <ComponentCard title={editMode ? "Edit Document Type" : "Add Document Type"}>
        <div className="space-y-2 mb-4">
          ...
          <Input
            ...
            type="text"
            id="name"
            onChange={(e) => setDocumentType((prev: any) => ({ ...prev, name: e.target.value }))}
            required
        ...
        <div className="space-y-2 mb-4">
          ...
          <textarea
            ...
            id="description"
            onChange={(e) => setDocumentType((prev: any) => ({ ...prev, description: e.target.value }))}
            required
        ...
        <div className="mb-6">
          <Checkbox
            ...
            onChange={(e:any) =>
              setDocumentType((prev: any) => ({ ...prev, isActive: e.target.checked }))
            }
            label="Is Active"
