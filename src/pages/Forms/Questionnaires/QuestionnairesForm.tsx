...
const QuestionnairesForm = ({
  ...
  return (
    <form onSubmit={handleSubmit}>
      <ComponentCard title={editMode ? "Edit Questionnaire" : "Add New Questionnaire"}>
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              id="title"
              onChange={(e) =>
                setQuestionnaires((prev: any) => ({ ...prev, title: e.target.value }))
              }
              required
            />
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              id="description"
              onChange={(e) =>
                setQuestionnaires((prev: any) => ({ ...prev, description: e.target.value }))
              }
            />
          </div>
          ...
          <div className="flex items-center space-x-3 col-span-2">
            <input
              ...
              onChange={(e) =>
                setQuestionnaires((prev: any) => ({ ...prev, is_active: e.target.checked }))
              }
