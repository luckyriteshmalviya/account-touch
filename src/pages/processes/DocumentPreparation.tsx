...
export default function DocumentPreparation({
  ...
  const handleFileChange = async (
    ...
    if (!documentTypeIdentifier) {
      console.error("Missing document type identifier", documentType);
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        {document.file_url && (
                          <a
                            ...
                            className="px-4 py-2 rounded-md text-sm font-medium bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                          >
                            View Document
                          </a>
                        )}
